...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { email: @hotel.email, location: @hotel.location, phone: @hotel.phone, room_id: @hotel.room_id }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { email: @hotel.email, location: @hotel.location, phone: @hotel.phone, room_id: @hotel.room_id }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
